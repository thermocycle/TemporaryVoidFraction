...
model HX_singlephase_Condenser
  "HX singlephase model compatible with MSL - countercurrent configuration only"
  replaceable package MediumPs =ThermoCycle.Media.Air_CP  constrainedby
  ...
  replaceable package MediumSs =ThermoCycle.Media.R600a_CP  constrainedby
...
protected
  ...
  /*Metal Wall*/
public
  parameter Modelica.SIunits.Mass M_wall= 2.15 "Mass of the Wall";
  parameter Modelica.SIunits.SpecificHeatCapacity c_wall= 500
    "Specific heat capacity of the metal wall";

  parameter Modelica.SIunits.Mass M_ps = 0.1 "Mass of the fluid"
                        annotation (Dialog(group="Primary side", tab="General"));
  parameter Modelica.SIunits.MassFlowRate MdotNom_ps = 0.025
    "Nominal mass flow rate" annotation (Dialog(group="Primary side", tab="General"));

  parameter Modelica.SIunits.Mass M_ss = 0.025 "Mass of the fluid"
                        annotation (Dialog(group="Secondary side", tab="General"));
  parameter Modelica.SIunits.MassFlowRate MdotNom_ss = 0.0003
  ...
  parameter Modelica.SIunits.Area A_ps=0.65 "Heat transfer area primary side" annotation (Dialog(group="Heat transfer", tab="General", enable=(not Use_AU)));
  parameter Modelica.SIunits.Area A_ss=0.125 "Heat transfer area secondary side"                         annotation (Dialog(group="Heat transfer", tab="General", enable=(not Use_AU)));
  parameter Modelica.SIunits.CoefficientOfHeatTransfer U_ps = 15
    "Constant heat transfer coefficient primary side" annotation (Dialog(group="Heat transfer", tab="General"));
  parameter Modelica.SIunits.CoefficientOfHeatTransfer U_ss = 350
  ...
  MediumSs.SaturationProperties sat_ss; // Added by Marco Diniz
...
equation
  ...
  sat_ss = MediumSs.setSat_p(InFlowSs.p); // Added by Marco Diniz
