...
model Cell1Dim_NoVoidFraction_Upwind
  ...
  ThermoCycle.Components.FluidFlow.Pipes.Cell1Dim Condenser(
    redeclare package Medium = Media.R600a_CP_Smooth,
    Vi=0.000089,
    Ai=0.106,
    Unom_l=10000,
  ...
  ThermoCycle.Components.FluidFlow.Pipes.Cell1Dim Evaporator(
    redeclare package Medium = Media.R600a_CP_Smooth,
    Mdotnom=0.000259,
    Unom_l=10000,
    Unom_tp=10000,
...
initial equation
   M_total_init = SuctionLine.M_tot +
             hermeticRecipCompressor.SuctionPlenum.M_tot +
             hermeticRecipCompressor.DischargePlenum.M_tot +
             DischargeLine.M_tot +
             Condenser.M_tot +
...
equation
  ...
  connect(CondenserOutlet.InFlow, Condenser.OutFlow) annotation (Line(points={{
          -67.94,40.2},{-55.97,40.2},{-55.97,40.1},{-44,40.1}}, color={0,0,255}));
  connect(Evaporator.OutFlow, EvaporatorOutlet.InFlow) annotation (Line(points={{-32,
          -38.1},{-24,-38.1},{-24,-37.8},{-15.94,-37.8}},       color={0,0,255}));
  connect(EvaporatorInlet.InFlow, Evaporator.InFlow) annotation (Line(points={{-59.94,
          -37.8},{-55.97,-37.8},{-55.97,-38},{-52,-38}},        color={0,0,255}));
  connect(Evaporator.Wall_int, metalWallL1.Wall_int)
    annotation (Line(points={{-42,-43},{-42,-43},{-42,-49}}, color={255,0,0}));
...
end Cell1Dim_NoVoidFraction_Upwind;
