...
equation
  ...
  /* Inserted by Marco Diniz */
//  epsilon_v = 0.7;
  epsilon_v = 0.702690508560442 + 4.23150145556432e-6*p_su - 5.50045227609243e-7*p_ex;
  //epsilon_s = 0.88395804259721 + 109998.40386731/p_su + 7.54098125063624e-11*p_su*p_ex + 488131666133.012/p_ex^2 -1.27551532987763e21/(p_su^2*p_ex^2) - 3.03225211420703e-6*p_ex - 4.92648224668338e-5*p_su;
  epsilon_s = 1*1.038;
